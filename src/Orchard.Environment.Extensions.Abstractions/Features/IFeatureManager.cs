...
namespace Orchard.Environment.Extensions.Features
{
    ...
    public interface IFeatureManager : IDependency
    {
        ...
        Task<IEnumerable<string>> EnableFeatures(IEnumerable<string> featureIds);
        ...
        /// <returns>An enumeration with the enabled feature IDs.</returns>
        Task<IEnumerable<string>> EnableFeatures(IEnumerable<string> featureIds, bool force);
        ...
        Task<IEnumerable<string>> DisableFeatures(IEnumerable<string> featureIds);
        ...
        /// <returns>An enumeration with the disabled feature IDs.</returns>
        Task<IEnumerable<string>> DisableFeatures(IEnumerable<string> featureIds, bool force);
        ...
        Task<IEnumerable<string>> GetDependentFeatures(string featureId);
    }
}